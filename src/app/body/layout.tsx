    ...
    <div className="mx-auto max-w-[1320px] px-9 py-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          ...
          className="bg-emerald-500/20 px-3 py-1.5 text-sm font-medium text-emerald-400 transition duration-150 ease-out-strong active:scale-[0.97] hover:bg-emerald-500/30"
        >
          Start Workout
        </Link>
      </div>
